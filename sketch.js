...
function drawScene(y1,y2){
  ...
  let Apx = (FEl.value/kEl.value)*SCALE;
...
function drawForces(y1,y2){
  ...
  // πρόσημο δύναμης
  let Fel_sign = -Math.sign(x);

  // βάρη
  drawArrow(cx,y1,40,color(0,0,255));
  drawArrow(cx,y2,40,color(0,0,255));

  // ✅ ελατήριο με ΣΩΣΤΗ φορά
  drawArrow(cx-20,y1,-40*Fel_sign,color(0,150,0));
  drawArrow(cx-20,y2, 40*Fel_sign,color(0,150,0));
